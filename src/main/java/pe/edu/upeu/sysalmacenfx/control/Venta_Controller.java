...
public class Venta_Controller {
    ...
    TextField dniRuc;
    @FXML
    TableView<VentaCarrito> tableView;
    ...
    public void listarProducto(){
        //System.out.println(ps.listAutoCompletProducto().get(0).getNameDysplay());
    ...
    public void personalizarTabla(){
        ...
        TableViewHelper<VentaCarrito> tableViewHelper = new TableViewHelper<>();
        ...
        Consumer<VentaCarrito> updateAction = (VentaCarrito ventCarrito) -> { System.out.println("Actualizar: " + ventCarrito); };
        Consumer<VentaCarrito> deleteAction = (VentaCarrito ventCarrito) -> {deleteReg(ventCarrito); };
    ...
    public void listar(){
        ...
        List<VentaCarrito> lista=daoC.listaCarritoCliente(dniRuc.getText());
        double impoTotal = 0, igv = 0;
        for (VentaCarrito dato: lista){
    ...
    public void editVenCarrito(VentaCarrito obj) {
        System.out.println(obj.getDniruc());
    }
    public void deleteReg(VentaCarrito obj) {
    ...
    private void registarPCarrito(){
        try {
            VentaCarrito ss= VentaCarrito.builder()
    ...
    public void registrarVenta(){
        ...
        List<VentaCarrito> dd = daoC.listaCarritoCliente(dniRuc.getText());
        if (idX.getIdVenta() != 0) {
            for (VentaCarrito car : dd) {
